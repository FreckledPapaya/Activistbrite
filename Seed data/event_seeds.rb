event_1 = Event.create(title: "Refreshments and Resistance", 
    ...
    start_date: DateTime.new(2020,1,2,17), image_url: "image_url" "image_url", organizer_id: user_2.id) 
...
event_2 = Event.create(title: "Pride Riot", 
    ...
    start_date: DateTime.new(2019,10,5,9), end_date: DateTime.new(2019,10,6,11), image_url: "image_url" , organizer_id: user_5.id)
...
event_3 = Event.create(title: "The Queeries", 
    ...
    start_date: DateTime.new(2020,6,19,17), end_date: DateTime.new(2020,6,22,2), image_url: "image_url" , organizer_id: user_14.id)
...
event_5 = Event.create(title: "Feminist Craft Market", 
    ...
    start_date: DateTime.new(2020,4,17,16), end_date: DateTime.new(2020,4,17,21), image_url: "image_url" , organizer_id: user_9.id)
# 
# 
# 
...
event_20 = Event.create(title: "Speaking Our Truths: Pride Edition", 
    ...
    start_date: DateTime.new(2020,1,2,17), end_date: , image_url: "image_url" , organizer_id: user_14.id)
