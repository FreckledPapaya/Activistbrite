event_1 = Event.create(title: "Refreshments and Resistance", body: "Meet your neighbors and call your local reps!", start_date: DateTime.new(2021, 6, 1, 17), image_url: "event_1", organizer_id: user_2.id)
...
event_8 = Event.create(title: "Stitch n B*tch", 
    ...
    start_date: DateTime.new(2020,4,18,6), end_date: DateTime.new(2020,4,18,11), image_url: "image_url" , organizer_id:)
...
event_21 = Event.create(title: "Gender Intersect", 
    ...
    start_date: DateTime.new(2020,3,2,17), end_date: , image_url: "image_url" , organizer_id: user_14.id)
...
event_24 = Event.create(title: "Coldest Night of the Year", 
    ...
    start_date: DateTime.new(2020,2,22,17), end_date: , image_url: "image_url" , organizer_id:)
...
event_31 = Event.create(title: "Transforming Conflict", 
    ...
    start_date: DateTime.new(2020,5,3,14), end_date: DateTime.new(2020,5,3,16), image_url: "image_url" , organizer_id: user_14.id)
