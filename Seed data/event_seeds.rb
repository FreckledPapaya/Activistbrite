...
event_3 = Event.create(title: "The Queeries", 
    ...
    start_date: Date.new(2020,6,19,17), end_date: Date.new(2020,6,22,2), image_url: "image_url" , organizer_id: user_14.id)

event_4 = Event.create(title: "Climate Change Discussion", 
    body: "", 
    start_date: Date.new(2020,1,2,17), end_date: , image_url: "image_url" , organizer_id:)
event_5 = Event.create(title: "Feminist Craft Market", 
    ...
    start_date: Date.new(2020,4,17,16), end_date: Date.new(2020,4,17,21), image_url: "image_url" , organizer_id: user_9.id)
# 
# 
# 
...
event_20 = Event.create(title: "Speaking Our Truths: Pride Edition", 
    ...
    start_date: Date.new(2020,1,2,17), end_date: , image_url: "image_url" , organizer_id: user_14.id)
event_21 = Event.create(title: "Gender Intersect", 
    ...
    start_date: Date.new(2020,3,2,17), end_date: , image_url: "image_url" , organizer_id: user_14.id)
...
event_24 = Event.create(title: "Coldest Night of the Year", 
    body: "By walking and fundraising together, we will explore the chill and challenges of living on the streets in winter, while raising much-needed money for many nation-wide charity partners who serve and engage the homeless communities so well.
          ", 
    start_date: Date.new(2020,2,22,17), end_date: , image_url: "image_url" , organizer_id:)
...
event_30 = Event.create(title: "Stitch n B*tch", 
    ...
    start_date: Date.new(2020,4,18,6), end_date: Date.new(2020,4,18,11), image_url: "image_url" , organizer_id:)
event_31 = Event.create(title: "Transforming Conflict", 
    ...
    start_date: Date.new(2020,5,3,14), end_date: Date.new(2020,5,3,16), image_url: "image_url" , organizer_id: user_14.id)
