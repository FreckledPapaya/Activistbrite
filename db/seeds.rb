...
event_8 = Event.create(title: "Stitch n B*tch", 
    ...
    start_date: DateTime.new(2020,4,18,6), end_date: DateTime.new(2020,4,18,11),  organizer_id: user_5.id) 

file = File.open(asset_path('crafty.jpg')) 
