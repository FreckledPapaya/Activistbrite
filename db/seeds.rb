...
event_1 = Event.create(title: "Refreshments and Resistance", 
    ...
    start_date: Date.new(2020,1,2,17), image_url: "event_1.jpg", organizer_id: user_2.id) 
...
event_2 = Event.create(title: "Pride Riot", 
    ...
    start_date: Date.new(2019,10,5,9), end_date: Date.new(2019,10,6,11), image_url: "event_2.jpg" , organizer_id: user_5.id)
file = File.open('/Users/freckledpapaya/Desktop/Activistbrite/public/images/event_2.jpg')
...
#     start_date: Date.new(2020,6,19,17), end_date: Date.new(2020,6,22,2), image_url: "event_3.jpg" , organizer_id: user_14.id)
...
event_5 = Event.create(title: "Feminist Craft Market", 
    ...
    start_date: Date.new(2020,4,17,16), end_date: Date.new(2020,4,17,21), image_url: "event_5.jpg" , organizer_id: user_9.id)
